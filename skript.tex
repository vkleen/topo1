...
Aber dann ist $U_i$ fur jedes für jedes $i\in I$ eine offene Umgebung von $x_i$. Da $(\pi_i)_*\cal F$ gegen $x_i$ konvergiert, ist dann $U_i\in (\pi_i)_*\cal F$, \ddh~$\pi_i^{-1}(U_i)\in\cal F$. Aber dann ist $\bigcap_{i\in J} \pi_i^{-1}(U_i)\in\cal F$, da $J$ endlich ist. Außerdem ist
\[
