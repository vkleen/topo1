...
\newcommand{\Mat}[1]{\ensuremath{\mathord{\textnormal{\sffamily Mat}}_{#1}}}
\newcommand{\FinVect}[1]{\ensuremath{\mathord{\textnormal{\sffamily FinVect}}_{#1}}}
...
\newcommand{\Cov}[1]{\textnormal{\sffamily Cov}_{#1}}
\newcommand{\GSet}[1]{\textnormal{\sffamily \ensuremath{#1}-Set}}
...
\newcommand*{\powerset}[1]{\ensuremath{\operatorname{\cal P}(#1)}}
...
\newcommand{\acts}{\mathrel{\raisebox{0.8em}{\rotatebox{-90}{$\circlearrowright$}}}}
\DeclareMathOperator{\fibre}{\textnormal{fib}}
